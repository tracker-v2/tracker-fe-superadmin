...
import { updateDeviceApi, getDeviceModelsApi } from '@/api/device'
...
export function DialogDeviceEdit({
    ...
    // SWR Mutation for updating device
    const { trigger, isMutating } = useSWRMutation(
        `/devices/edit/${device.id}`,
        (_, { arg }: { arg: FormSchema }) => updateDeviceApi(device.id, arg),
        {
            onSuccess() {
            ...
            onError(error: AxiosError | unknown) {
                const errorMessage = (error as AxiosError<{ message: string }>)?.response?.data?.message || 'Gagal memperbarui device'
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            >
                <DialogHeader>
                    ...
                    <DialogDescription>Perbarui data device</DialogDescription>
                </DialogHeader>
                    ...
                    <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
                        ...
                        <DialogFooter>
                            ...
                            >
                                ...
                                {isMutating ? 'Menyimpan...' : 'Perbarui Device'}
                            </Button>
                        </DialogFooter>
                    </form>
                </Form>

                        ...
                        <div className="p-4 bg-red-50 border-b border-red-200 flex items-start gap-3">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-red-700 text-xs sm:text-sm mt-1">
                                    {error?.message ||
                                        "Terjadi kesalahan saat mengambil data device. Silakan coba lagi."}
                                </p>
                                <Button
                    ...
                    {isLoading && (
                        <div className="flex items-center justify-center flex-1 min-h-[400px]">
                            <div className="flex flex-col items-center gap-3">
                                ...
                                <p className="text-gray-600 text-sm">Memuat data device...</p>
                            </div>
                        </div>
                    )}
                        ...
                        <div className="flex items-center justify-center flex-1 min-h-[400px]">
                            <div className="text-center">
                                <p className="text-gray-600 mb-4 text-sm sm:text-base">
                                    {search
                                        ? "Tidak ada device yang sesuai dengan pencarian"
